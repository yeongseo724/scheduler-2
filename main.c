...
int main(int argc, char *argv[]) {
	...
	while (fgets(cnt,200,fp)!=NULL /* read from the file*/ )
	{	
	...
	while(exit_flag == 0) 
	{
		...
		switch(option)
		{
			...
			case 4:
				...
				if ( valid=0/*convert the type and check if the type is valid */)
				{
					ndPtr = list;
					while (list_isEndNode(ndPtr) == 0)
					{
